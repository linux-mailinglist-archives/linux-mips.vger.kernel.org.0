...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 778231C76A4
	for <lists+linux-mips@lfdr.de>; Wed,  6 May 2020 18:37:03 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729341AbgEFQg4 (ORCPT <rfc822;lists+linux-mips@lfdr.de>);
        Wed, 6 May 2020 12:36:56 -0400
Received: from elvis.franken.de ([193.175.24.41]:42499 "EHLO elvis.franken.de"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1730065AbgEFQg4 (ORCPT <rfc822;linux-mips@vger.kernel.org>);
        Wed, 6 May 2020 12:36:56 -0400
Received: from uucp (helo=alpha)
        by elvis.franken.de with local-bsmtp (Exim 3.36 #1)
        id 1jWN2S-00084D-00; Wed, 06 May 2020 18:36:52 +0200
Received: by alpha.franken.de (Postfix, from userid 1000)
        id 54937C0371; Wed,  6 May 2020 18:36:43 +0200 (CEST)
Date:   Wed, 6 May 2020 18:36:43 +0200
From:   Thomas Bogendoerfer <tsbogend@alpha.franken.de>
To:     Joshua Kinard <kumba@gentoo.org>
Cc:     linux-mips@vger.kernel.org
Subject: Re: [PATCH] Add missing ifdefs to SGI Platform files for IP22, IP32
Message-ID: <20200506163643.GA18192@alpha.franken.de>
References: <87be6e36-04de-684b-0361-91de9ce2c731@gentoo.org>
 ...
 <69f0ba65-161c-744a-42c0-c8bb435cce3c@gentoo.org>
MIME-Version: 1.0
...
On Tue, Apr 21, 2020 at 02:13:23AM -0400, Joshua Kinard wrote:
...
thank you for the detailed analysis. I'd propose a different solution
for the pronlem. How about just included the one Platform file needed ?

Below is a patch implementing this, I've built tested about 20 platforms.
If I haven't overlooked something I'm going to push this to mips-next.

Thomas.


From f75140365afe5fc1ecef762f40ee96914ccf04f6 Mon Sep 17 00:00:00 2001
From: Thomas Bogendoerfer <tsbogend@alpha.franken.de>
Date: Wed, 6 May 2020 18:24:02 +0200
Subject: [RFC] MIPS: Only include the platform file needed
...
---
 ...
 32 files changed, 39 insertions(+), 80 deletions(-)

diff --git a/arch/mips/Kbuild.platforms b/arch/mips/Kbuild.platforms
index a69b272a3ab0..5e3f6ed96292 100644
