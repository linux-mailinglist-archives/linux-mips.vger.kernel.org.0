Return-Path: <linux-mips+bounces-13503-lists+linux-mips=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-mips@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id aJAmNhUWsGknfgIAu9opvQ
	(envelope-from <linux-mips+bounces-13503-lists+linux-mips=lfdr.de@vger.kernel.org>)
	for <lists+linux-mips@lfdr.de>; Tue, 10 Mar 2026 14:01:09 +0100
X-Original-To: lists+linux-mips@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id 9FF6524F4C1
	for <lists+linux-mips@lfdr.de>; Tue, 10 Mar 2026 14:01:04 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 47B8732BF1A3
	for <lists+linux-mips@lfdr.de>; Tue, 10 Mar 2026 12:35:17 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 402023F99CC;
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	TAGGED_FROM(0.00)[bounces-13503-lists,linux-mips=lfdr.de];
	...
	RSPAMD_EMAILBL_FAIL(0.00)[gregory.clement.bootlin.com:query timed out,maz.kernel.org:query timed out,tglx.kernel.org:query timed out];
	RCPT_COUNT_GT_50(0.00)[59];
	MID_RHS_MATCH_FROM(0.00)[];
	NEURAL_HAM(-0.00)[-1.000];
	TO_DN_SOME(0.00)[];
	TAGGED_RCPT(0.00)[linux-mips];
	DBL_BLOCKED_OPENRESOLVER(0.00)[avm.de:dkim,avm.de:email,avm.de:mid,tor.lore.kernel.org:rdns,tor.lore.kernel.org:helo,lunn.ch:email,bootlin.com:email,infradead.org:email]
