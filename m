Return-Path: <linux-mips+bounces-15197-lists+linux-mips=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-mips@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id vWOoB+AAPGobiQgAu9opvQ
	(envelope-from <linux-mips+bounces-15197-lists+linux-mips=lfdr.de@vger.kernel.org>)
	for <lists+linux-mips@lfdr.de>; Wed, 24 Jun 2026 18:08:00 +0200
X-Original-To: lists+linux-mips@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 883226BFE7E
	for <lists+linux-mips@lfdr.de>; Wed, 24 Jun 2026 18:07:59 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=amd.com header.s=selector1 header.b=TBblVmJj;
	spf=pass (mail.lfdr.de: domain of "linux-mips+bounces-15197-lists+linux-mips=lfdr.de@vger.kernel.org" designates 172.234.253.10 as permitted sender) smtp.mailfrom="linux-mips+bounces-15197-lists+linux-mips=lfdr.de@vger.kernel.org";
	dmarc=pass (policy=quarantine) header.from=amd.com;
	arc=reject ("cv is fail on i=2")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id BE11930053F1
	for <lists+linux-mips@lfdr.de>; Wed, 24 Jun 2026 16:06:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0AFDE38BF8D;
...
X-Spamd-Result: default: False [-0.16 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-15197-lists,linux-mips=lfdr.de];
	...
	FORGED_SENDER(0.00)[harry.wentland@amd.com,linux-mips@vger.kernel.org];
	...
	FROM_NEQ_ENVFROM(0.00)[harry.wentland@amd.com,linux-mips@vger.kernel.org];
