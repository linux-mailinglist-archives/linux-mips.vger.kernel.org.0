...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7934942D500
	for <lists+linux-mips@lfdr.de>; Thu, 14 Oct 2021 10:32:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230267AbhJNIex (ORCPT <rfc822;lists+linux-mips@lfdr.de>);
        Thu, 14 Oct 2021 04:34:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42698 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230248AbhJNIeu (ORCPT
        <rfc822;linux-mips@vger.kernel.org>); Thu, 14 Oct 2021 04:34:50 -0400
Received: from mail-pj1-x1029.google.com (mail-pj1-x1029.google.com [IPv6:2607:f8b0:4864:20::1029])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A3086C061570;
        Thu, 14 Oct 2021 01:32:45 -0700 (PDT)
Received: by mail-pj1-x1029.google.com with SMTP id oa4so4206605pjb.2;
        Thu, 14 Oct 2021 01:32:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=wgiwV35VyoYIPMvS/jOIcbZ5ObGfGIoVsUJqgerd1RI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=wgiwV35VyoYIPMvS/jOIcbZ5ObGfGIoVsUJqgerd1RI=;
        b=
X-Gm-Message-State: AOAM5300C88Bb/6XbpQtkhvCmsXo60JNjTNJCoDz1W41YQiyn44FeRMu
        iZAOpsyP+hQZVDeW+8Sny0I=
X-Google-Smtp-Source: ABdhPJym7Jtr38byeES4u/WBmLSVyoEe6rBE+HY2fnJ6eUQQngKLquNU0EcLz06dQ0R/gPO/rvK0/w==
X-Received: by 2002:a17:90a:de16:: with SMTP id m22mr18983910pjv.38.1634200364502;
        Thu, 14 Oct 2021 01:32:44 -0700 (PDT)
Received: from archlinux.localdomain (61-218-132-193.hinet-ip.hinet.net. [61.218.132.193])
        by smtp.gmail.com with ESMTPSA id z23sm1802004pgv.45.2021.10.14.01.32.38
...
Subject: [PATCH v3 1/2] MIPS: convert syscall to generic entry
Date:   Thu, 14 Oct 2021 16:32:53 +0800
Message-Id: <31a97087b56c703606b8d871ac35d2192928fe6b.1634177547.git.chenfeiyang@loongson.cn>
...
+	return 0;
 ...
 #ifdef CONFIG_TRAD_SIGNALS
@@ -852,11 +841,11 @@ static void handle_signal(struct ksignal *ksig, struct pt_regs *regs)
...
+	if (has_signal && get_signal(&ksig)) {
 		...
 		return;
@@ -904,7 +893,7 @@ asmlinkage void do_notify_resume(struct pt_regs *regs, void *unused,
...
@@ -253,7 +247,7 @@ struct mips_abi mips_abi_32 = {
 };
