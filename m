...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A059E109C93
	for <lists+linux-mips@lfdr.de>; Tue, 26 Nov 2019 11:52:21 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727825AbfKZKwV (ORCPT <rfc822;lists+linux-mips@lfdr.de>);
        Tue, 26 Nov 2019 05:52:21 -0500
Received: from foss.arm.com ([217.140.110.172]:32838 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727817AbfKZKwU (ORCPT <rfc822;linux-mips@vger.kernel.org>);
        Tue, 26 Nov 2019 05:52:20 -0500
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 69A541FB;
        Tue, 26 Nov 2019 02:52:19 -0800 (PST)
Received: from [10.1.196.72] (e119884-lin.cambridge.arm.com [10.1.196.72])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 668263F52E;
        Tue, 26 Nov 2019 02:52:18 -0800 (PST)
...
Message-ID: <3190d1a4-96c4-1843-3ae1-bae3a97af9fb@arm.com>
Date:   Tue, 26 Nov 2019 10:52:17 +0000
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101
 Thunderbird/60.9.0
MIME-Version: 1.0
In-Reply-To: <703DC004-96E8-463D-8870-3CC410FE1C5E@goldelico.com>
Content-Type: multipart/mixed;
 boundary="------------4024DF897A21994B84AAFCAF"
...
--------------4024DF897A21994B84AAFCAF
Content-Type: text/plain; charset=utf-8
Content-Transfer-Encoding: quoted-printable

Hi Nikolaus,

sorry for the delay in answering to your email but due to personal reason=
s I had
...
> from mips_vdso_data.
>=20
> What I would assume is that the struct mips_vdso_data is embossed in us=
er
> space code and therefore using vdso_data instead is breaking API.
>

vdso_data and mips_vdso_data before are not part of the ABI hence they ar=
e not
bind by a contract with the userspace.

This means that they can change at any point and if a userspace software =
relies
...
I do not have a CI20 hence I can't do the test myself: could you please w=
rite a
small application that invokes gettimeofday() as per above and report the=

behavior (I am even interested in the value returned). If we can reproduc=
e the
problem in a smaller environment it is easier to debug and get to the sol=
ution.

[1] http://users.isc.org/~each/doxygen/bind9/isc_2unix_2time_8c-source.ht=
ml
