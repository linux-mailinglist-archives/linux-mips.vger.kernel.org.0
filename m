...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B3CDF403279
	for <lists+linux-mips@lfdr.de>; Wed,  8 Sep 2021 04:08:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1347068AbhIHCJw (ORCPT <rfc822;lists+linux-mips@lfdr.de>);
        Tue, 7 Sep 2021 22:09:52 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33188 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1347006AbhIHCJv (ORCPT
        <rfc822;linux-mips@vger.kernel.org>); Tue, 7 Sep 2021 22:09:51 -0400
Received: from mail-pg1-x52e.google.com (mail-pg1-x52e.google.com [IPv6:2607:f8b0:4864:20::52e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C717CC061575;
        Tue,  7 Sep 2021 19:08:44 -0700 (PDT)
Received: by mail-pg1-x52e.google.com with SMTP id t1so902675pgv.3;
        Tue, 07 Sep 2021 19:08:44 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc:content-transfer-encoding;
        bh=B6uqJRgaG3m5MbfmZUTrcun1L4Ths3qPs2h1ZyFfacE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=B6uqJRgaG3m5MbfmZUTrcun1L4Ths3qPs2h1ZyFfacE=;
        b=
X-Gm-Message-State: AOAM533izHjjjqlqmntLXpq9zoLbK0kQMjgpKyWU59rikFYZhp9CtZAJ
        OOKVu8s2zBjSdYIThcJRNY2L2NjDyS0sc2yx5x0=
X-Google-Smtp-Source: ABdhPJxYXW9SmTMTWikktbELyxomnktHhAofMUKbf45iY5tkNZ3FDL7tdLOf4rwEakoOWfhc0sZ0TSFH6jkfazhITVw=
X-Received: by 2002:a63:c10b:: with SMTP id w11mr1352678pgf.228.1631066923586;
 Tue, 07 Sep 2021 19:08:43 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <59feb382-a4ab-c94e-8f71-10ad0c0ceceb@flygoat.com>
From:   =?UTF-8?B?6ZmI6aOe5oms?= <chris.chenfeiyang@gmail.com>
Date:   Wed, 8 Sep 2021 10:08:47 +0800
Message-ID: <CACWXhKnA24KuJo33+OitPQVRRd3g_05DWRC2Dsnm7w8hVyKjNQ@mail.gmail.com>
Subject: Re: [PATCH 1/2] mips: convert syscall to generic entry
To:     Jiaxun Yang <jiaxun.yang@flygoat.com>
Cc:     tsbogend@alpha.franken.de, tglx@linutronix.de,
...
> > diff --git a/arch/mips/include/asm/entry-common.h b/arch/mips/include/a=
sm/entry-common.h
...
> > +
> > +#endif
> > diff --git a/arch/mips/include/asm/ptrace.h b/arch/mips/include/asm/ptr=
ace.h
...
> >
> >   static inline void die_if_kernel(const char *str, struct pt_regs *reg=
s)
...
> > @@ -157,4 +157,9 @@ static inline int syscall_get_arch(struct task_stru=
ct *task)
> >       return arch;
> >   }
> >
...
> > diff --git a/arch/mips/include/asm/thread_info.h b/arch/mips/include/as=
m/thread_info.h
...
> >
> >   /*
> > @@ -69,6 +70,8 @@ static inline struct thread_info *current_thread_info=
(void)
...
> > @@ -149,22 +152,10 @@ static inline struct thread_info *current_thread_=
info(void)
...
> >
> > -obj-y                +=3D branch.o cmpxchg.o elf.o entry.o genex.o idl=
e.o irq.o \
> > -                process.o prom.o ptrace.o reset.o setup.o signal.o \
> > -                syscall.o time.o topology.o traps.o unaligned.o watch.=
o \
> > -                vdso.o cacheinfo.o
> > +obj-y                +=3D branch.o cacheinfo.o cmpxchg.o elf.o entry.o=
 genex.o \
...
> >    *
> > @@ -1305,78 +1302,3 @@ long arch_ptrace(struct task_struct *child, long=
 request,
> >    out:
> >       return ret;
> >   }
...
> > - * for more details.
> > - *
> > - * Copyright (C) 1995-99, 2000- 02, 06 Ralf Baechle <ralf@linux-mips.o=
rg>
> > - * Copyright (C) 2001 MIPS Technologies, Inc.
> > - * Copyright (C) 2004 Thiemo Seufer
> > - * Copyright (C) 2014 Imagination Technologies Ltd.
...
> >   #include <asm/war.h>
> > @@ -627,7 +626,7 @@ SYSCALL_DEFINE3(sigaction, int, sig, const struct s=
igaction __user *, act,
> >   #endif
> >
...
> >
> >   #ifdef CONFIG_TRAD_SIGNALS
> > @@ -852,11 +839,11 @@ static void handle_signal(struct ksignal *ksig, s=
truct pt_regs *regs)
...
> >               return;
> > @@ -904,7 +891,7 @@ asmlinkage void do_notify_resume(struct pt_regs *re=
gs, void *unused,
> >
...
> > diff --git a/arch/mips/kernel/signal_n32.c b/arch/mips/kernel/signal_n3=
2.c
...
> > diff --git a/arch/mips/kernel/signal_o32.c b/arch/mips/kernel/signal_o3=
2.c
...
> > @@ -151,7 +150,7 @@ static int setup_frame_32(void *sig_return, struct =
ksignal *ksig,
> >       return 0;
> >   }
> >
...
> >
> > @@ -79,10 +80,6 @@ SYSCALL_DEFINE6(mips_mmap2, unsigned long, addr, uns=
igned long, len,
> >                              pgoff >> (PAGE_SHIFT - 12));
> >   }
> >
...
> > @@ -182,28 +179,11 @@ static inline int mips_atomic_set(unsigned long a=
ddr, unsigned long new)
> >               return err;
> >
...
> >
> > -/*
> > - * mips_atomic_set() normally returns directly via syscall_exit potent=
ially
...
> > +}
> > diff --git a/arch/mips/kernel/syscalls/syscall_n32.tbl b/arch/mips/kern=
el/syscalls/syscall_n32.tbl
...
> > diff --git a/arch/mips/kernel/syscalls/syscall_n64.tbl b/arch/mips/kern=
el/syscalls/syscall_n64.tbl
...
> > diff --git a/arch/mips/kernel/syscalls/syscall_o32.tbl b/arch/mips/kern=
el/syscalls/syscall_o32.tbl
