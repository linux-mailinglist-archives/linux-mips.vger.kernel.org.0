Return-Path: <linux-mips+bounces-14429-lists+linux-mips=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-mips@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id wGekFenB9mkDYQIAu9opvQ
	(envelope-from <linux-mips+bounces-14429-lists+linux-mips=lfdr.de@vger.kernel.org>)
	for <lists+linux-mips@lfdr.de>; Sun, 03 May 2026 05:32:57 +0200
X-Original-To: lists+linux-mips@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 82D594B4469
	for <lists+linux-mips@lfdr.de>; Sun, 03 May 2026 05:32:56 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 430C53009CDE
	for <lists+linux-mips@lfdr.de>; Sun,  3 May 2026 03:32:55 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CDD2A23C4F2;
	Sun,  3 May 2026 03:32:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="VP8uSKOu"
X-Original-To: linux-mips@vger.kernel.org
Received: from mail-dy1-f195.google.com (mail-dy1-f195.google.com [74.125.82.195])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 629E12222D0
	for <linux-mips@vger.kernel.org>; Sun,  3 May 2026 03:32:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=74.125.82.195
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1777779174; cv=none; b=hCVFxAAlwE9CpgWNR9aHwie4l5DgfrK74eFakAVAQPrrGGCHSyBmlucwd7eVM6hHEzvHewu4wmIOcV0a/tvUxnypBnTqjJgbHZsOD88ewacQPSMO957vO8Wu3H6wMXna1LppMzw9jMXBn/pycEoYKhPKKEeHcjWuLuH9OMjMsHA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1777779174; c=relaxed/simple;
	bh=7D6avSTq/SPPEatva+2C7XkqJXnjWzM5lMJ3Ngvaq5w=;
	h=From:To:Cc:Subject:Date:Message-ID:MIME-Version; b=XdSP4oJesVnyeV2p25eyRc9oey04iVSG54rmODow6PJZZwlCBdj2ODapZLDI0E9h3ZRXmEE/qAiFJfIicrzPrXhiVNSoCfvgFM4QfPpwxGl6OcvK7ojcDteZRVauokLBor9l0VHUTXjteVkSBITZpNzNA9J5hNFjsU3WzGV1v1U=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=VP8uSKOu; arc=none smtp.client-ip=74.125.82.195
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-dy1-f195.google.com with SMTP id 5a478bee46e88-2ecf9e398f4so6572771eec.1
        for <linux-mips@vger.kernel.org>; Sat, 02 May 2026 20:32:51 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20251104; t=1777779170; x=1778383970; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         :to:from:from:to:cc:subject:date:message-id:reply-to;
        bh=9tSCfUxHG3dQHhehHHrapMKvjj+dWwJAojqwx/CYic8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20251104; t=1777779170; x=1778383970;
        h=content-transfer-encoding:mime-version:message-id:date:subject:cc
         :to:from:x-gm-gg:x-gm-message-state:from:to:cc:subject:date
         :message-id:reply-to;
        bh=9tSCfUxHG3dQHhehHHrapMKvjj+dWwJAojqwx/CYic8=;
        b=
X-Gm-Message-State: AOJu0YwtUsLNi6tNkZsUtpRmO17knQz/aLPtgnkIkxXKCt+YhT+DEQI4
	5/2uwoTN8Uy4elTSfwbBzSLVRS2hRzPMKyUjhGC4Runs1uDulVUu3RN60/cWjcBC
X-Gm-Gg: 
	+6dbNqGTVvrqvgPhV2Uo+sK9iPYH
X-Received: by 2002:a05:7301:9f06:b0:2c9:1943:e7ff with SMTP id 5a478bee46e88-2efb80bec60mr2255544eec.10.1777779169902;
        Sat, 02 May 2026 20:32:49 -0700 (PDT)
Received: from ethan-latitude5420.. (host-127-24.cafrjco.fresno.ca.us.clients.pavlovmedia.net. [68.180.127.24])
        by smtp.gmail.com with ESMTPSA id 5a478bee46e88-2ee38e71cedsm12763423eec.9.2026.05.02.20.32.48
...
Subject: [PATCH bluetooth-next v2] bluetooth: remove all PCMCIA drivers
Date: Sat,  2 May 2026 20:31:21 -0700
Message-ID: <20260503033201.19719-1-enelsonmoore@gmail.com>
...
X-Spamd-Result: default: False [0.84 / 15.00];
	...
	FREEMAIL_CC(0.00)[gmail.com,armlinux.org.uk,kernel.org,xen0n.name,alpha.franken.de,linux.ibm.com,ellerman.id.au,holtmann.org,gondor.apana.org.au,mit.edu,linaro.org,linux-m68k.org,ixit.cz];
	RCVD_TLS_LAST(0.00)[];
	FREEMAIL_FROM(0.00)[gmail.com];
	MIME_TRACE(0.00)[0:+];
	RCPT_COUNT_TWELVE(0.00)[23];
	TAGGED_FROM(0.00)[bounces-14429-lists,linux-mips=lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[sea.lore.kernel.org:helo,sea.lore.kernel.org:rdns,uminho.pt:email]
