...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id C0A8B10C89A
	for <lists+linux-mips@lfdr.de>; Thu, 28 Nov 2019 13:21:08 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726700AbfK1MVI (ORCPT <rfc822;lists+linux-mips@lfdr.de>);
        Thu, 28 Nov 2019 07:21:08 -0500
Received: from foss.arm.com ([217.140.110.172]:34622 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726320AbfK1MVH (ORCPT <rfc822;linux-mips@vger.kernel.org>);
        Thu, 28 Nov 2019 07:21:07 -0500
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id A9ABC31B;
        Thu, 28 Nov 2019 04:21:06 -0800 (PST)
Received: from [10.1.196.72] (e119884-lin.cambridge.arm.com [10.1.196.72])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 921613F6C4;
        Thu, 28 Nov 2019 04:21:05 -0800 (PST)
...
References: <18788C50-F29B-4BD7-89F6-B056FF490214@goldelico.com>
 ...
 <dbf536da-77a6-30a0-a380-9463f604d1a8@arm.com>
 <AD919A0B-2629-4E8A-8A7A-1E4A868F8BC4@goldelico.com>
From:   Vincenzo Frascino <vincenzo.frascino@arm.com>
Message-ID: <7b6275c7-ab2b-a647-6bf7-d5e1c4523c98@arm.com>
Date:   Thu, 28 Nov 2019 12:21:04 +0000
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101
 Thunderbird/60.9.0
MIME-Version: 1.0
In-Reply-To: <AD919A0B-2629-4E8A-8A7A-1E4A868F8BC4@goldelico.com>
Content-Type: multipart/mixed;
 boundary="------------21083FED0C89E9F267758399"
...
--------------21083FED0C89E9F267758399
Content-Type: text/plain; charset=utf-8
Content-Transfer-Encoding: quoted-printable

On 28/11/2019 12:11, H. Nikolaus Schaller wrote:
>=20
>> Am 28.11.2019 um 12:51 schrieb Vincenzo Frascino <vincenzo.frascino@ar=
m.com>:
>>
>> Hi Nikolaus,
>>
...
>> [...]
>>
>>>> vdso_data and mips_vdso_data before are not part of the ABI hence th=
ey are not
>>>> bind by a contract with the userspace.
>>>>
>>>> This means that they can change at any point and if a userspace soft=
ware relies
>>>> on a specific layout of these data structures is doing something wro=
ng.
>>>
>>> Maybe the libs are clever enough to find that out dynamically but I h=
ave no
>>> idea about how gettimeofday() and user-space VDSO is implemented to h=
andle such
>>> changes.
>>>
...
>>
>> The only thing that userspace requires is to "know" that gettimeofday(=
) exists,
...
> and reads out the memory region where the VDSO data structure is provid=
ed by the
> kernel. And that part comes from Debian. Somehow it does differently wi=
th 4.19
> than 5.4. So I summarise all non-kernel code with the term "user-space"=
=2E
>=20

The the lib that provides the gettimeofday() changes accordingly with vds=
o_data.
