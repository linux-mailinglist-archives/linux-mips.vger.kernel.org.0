...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id EDAA42F4C73
	for <lists+linux-mips@lfdr.de>; Wed, 13 Jan 2021 14:48:50 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726721AbhAMNsP (ORCPT <rfc822;lists+linux-mips@lfdr.de>);
        Wed, 13 Jan 2021 08:48:15 -0500
Received: from mout.gmx.net ([212.227.17.21]:56403 "EHLO mout.gmx.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725772AbhAMNsP (ORCPT <rfc822;linux-mips@vger.kernel.org>);
        Wed, 13 Jan 2021 08:48:15 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=gmx.net;
        s=badeba3b8450; t=1610545562;
        bh=Jt8q2advlnvIBRSx3h6t6x1liNa0LBl8SxWgWAZxR44=;
        h=X-UI-Sender-Class:Date:From:To:Cc:Subject;
        b=iq1jkscFo82wYYrIw44Gq1Af2LKs7DlCKuh7LgCYmMyaqG9/2ip6qSFpcDFV7JkMx
         4EQw0UiLJaa6cToFwmjRCKdXzmzMd+vUoskIebybDx0AplUvhj1LV9xIIoF5oppsCl
         1dTrbgwg396jojy9fUIYjQqSXe7PBuGtoLHyWP6o=
X-UI-Sender-Class: 01bb95c1-4bf8-414a-932a-4f6e2808ef9c
Received: from Valinor ([82.203.161.65]) by mail.gmx.com (mrgmx104
 [212.227.17.174]) with ESMTPSA (Nemesis) id 1MAfUe-1kodrG0mcq-00B57K; Wed, 13
 Jan 2021 14:46:02 +0100
Date:   Wed, 13 Jan 2021 15:47:41 +0200
From:   Lauri Kasanen <cand@gmx.com>
To:     linux-mips@vger.kernel.org
Cc:     tsbogend@alpha.franken.de, Takashi Iwai <tiwai@suse.de>,
        perex@perex.cz
Subject: [PATCH 5/6 v5] sound: Add n64 driver
Message-Id: <20210113154741.e5f93ed383a77b795d3d26a3@gmx.com>
X-Mailer: Sylpheed 3.5.0 (GTK+ 2.18.6; x86_64-unknown-linux-gnu)
Mime-Version: 1.0
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable
X-Provags-ID: V03:K1:GnUEkOu8cAaDf+uONCH03luaK6kzNMugS5v13X/+VGwS+w3Mscz
 /n08FEAByU8qP0nOQ6I9r+fgGuB8eqoJ/zsUuDlkyG9NqnIN3W1ZP6TwhBCwCpF3BRjgc+Q
 2UjsVQGHbmEVQTbEgkZ98fk5DP/9FI/RxuJnWL2JrawEwDPqX1K1y3wx2QnIg9Jd/OFfy46
 NVpkp3LpM76PWRr+cskvQ==
X-Spam-Flag: NO
X-UI-Out-Filterresults: notjunk:1;V03:K0:NdNVNSlYzkY=:yZz8q8LQCZoGd6I/pGdXHV
 
Precedence: bulk
...
v5:
depend on SND=3Dy
remove unneeded ~7 check (handled by the step constraint)
use is_power_of_2
pass sizeof(*priv) to snd_card_new()
move irq assignment last
check for ioremap failure

v4:
correct pointer() advancing and hw double buffering
